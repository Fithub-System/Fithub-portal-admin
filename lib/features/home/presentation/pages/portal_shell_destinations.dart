/// Shell nav indices — FEAT-11 Install I1 + FEAT-30 Payouts rail.
///
/// Order locked: Home | Members | Staff | Classes | Marketing | Payouts | Reports
/// (`@specs/FEAT-11-PORTAL-SHELL-MATCH-STITCH.md` §2 US-A / §3 +
/// `@specs/FEAT-30-ADMIN-PAYOUT-QUEUE.md` §3 Payouts destination).
///
/// Stitch citations:
...
/// - Payouts EN `405663d1534848d2a96f1db4e76c35df` / AR `142d4cb868ff4aff8c040453bad737f9`
...
/// AR `9541b6e764dd436daa91336b0ce2263b` — not a rail tab.
abstract final class PortalShellDestinations {
  ...
  static const int reports = 6;

  static const int destinationCount = 7;
